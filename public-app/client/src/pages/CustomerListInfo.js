...
function CustomerListInfo() {
    ...
    const handleBackClick = () => navigate('/customer-list');
    ...
    useEffect(() => {
        const fetchCustomerData = async () => {
            setShowLoader(true)
            try {
                const response = await apiCall(`/customer/customerTransactions?store=${selectedValue}`, 'POST', { account_number: accountId });
